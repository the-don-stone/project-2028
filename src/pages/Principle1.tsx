            ...
            <div className="space-y-8">
              <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
                <CardContent className="pt-6">
                  <h2 className="text-2xl font-bold text-project-blue mb-4">The Foundational Standard</h2>
              ...
              <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
                <CardContent className="pt-6">
                  <h2 className="text-2xl font-bold text-project-blue mb-4">What This Means in Practice</h2>
                  <div className="prose prose-lg max-w-none">
              ...
              <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
                <CardContent className="pt-6">
                  <h2 className="text-2xl font-bold text-project-blue mb-4">The Policy Imperative: People Over Abstract Goals</h2>
                  <div className="prose prose-lg max-w-none">
              ...
              <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
                <CardContent className="pt-6">
                  <h2 className="text-2xl font-bold text-project-blue mb-4">Universality and Non-Discrimination</h2>
                  <div className="prose prose-lg max-w-none">
              ...
              <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
                <CardContent className="pt-6">
                  <h2 className="text-2xl font-bold text-project-blue mb-4">The Cornerstone of Project 2028</h2>
                  <div className="prose prose-lg max-w-none">
