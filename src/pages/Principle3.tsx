              ...
              <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
                <CardContent className="pt-6">
                  ...
                  <div className="prose prose-lg max-w-none">
                    ...
                    <ol>
                      <li><strong>Scientific Consensus:</strong> For complex issues like climate change, public health, and environmental protection, the overwhelming agreement reached by experts within the relevant scientific fields, based on the accumulated weight of research, must be the starting point for policy. Ignoring or contradicting broad scientific consensus is irresponsible and dangerous.</li>
                      <li><strong>Rigorous Data:</strong> This includes systematically collected quantitative data (statistics, measurements) and qualitative data (interviews, case studies) analyzed using sound, transparent methodologies. Investing in robust data collection infrastructure, including data disaggregated by relevant demographics (<strong>Equity</strong>), is essential to understand societal conditions and policy impacts accurately.</li>
                      <li><strong>Expert Knowledge:</strong> Leveraging the deep understanding and insights of individuals with specialized training and experience is critical. This includes not only natural and social scientists but also engineers, medical professionals, educators, urban planners, and other experts relevant to the policy area. Mechanisms for integrating diverse expert input into the policy process are vital.</li>
                    </ol>
                  </div>
                </CardContent>
              </Card>
